...
struct InventoryMenu : public Scene {
	...
	void Initialize() override {
		...
		//Factory::Instance().FF_CreateGUIChildSurfaceText(_title, { "transparent" }, 0.5f, 0.6f, 0.8f, 0.4f, "by HCMR4", "courier");
		...
		start = Factory::Instance().FF_CreateGUIChildClickableSurfaceText(_buttons_surface, button, 0.30f, 0.5f, 0.4f, 0.2f, OpenSurvey, "Survey", "courier");
		Factory::Instance()[start].AddComponent<Com_GUISurfaceHoverShadow>();
		start = Factory::Instance().FF_CreateGUIChildClickableSurfaceText(_buttons_surface, button, 0.70f, 0.5f, 0.4f, 0.2f, OpenSurvey, "Survey", "courier");
		Factory::Instance()[start].AddComponent<Com_GUISurfaceHoverShadow>();
